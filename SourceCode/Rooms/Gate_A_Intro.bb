...
Function UpdateEvent_Gate_A_Intro(e.Events)
	...
	If e\EventState = 0
		...
		UnableToMove = 2
		For i = 0 To 1
			e\room\NPC[i] = CreateNPC(NPCtypeMTF,EntityX(e\room\Objects[3],True),EntityY(e\room\Objects[3],True),EntityZ(e\room\Objects[3],True))
		...
		n.NPCs = CreateNPC(NPCtypeMTF,EntityX(e\room\Objects[9],True),EntityY(e\room\Objects[9],True)+0.5,EntityZ(e\room\Objects[9],True))
		n\State = 1
		n\State2 = 1
		...
		n.NPCs = CreateNPC(NPCtypeMTF,EntityX(e\room\Objects[10],True),EntityY(e\room\Objects[10],True)+0.5,EntityZ(e\room\Objects[10],True))
		n\State = 1
		n\State2 = 1
		PointEntity2(n\Collider, e\room\Objects[11],0,False)
	...
	Else
		...
		If e\EventState = 1
			CameraShake = 0.25
			ResetEntity Collider
			e\EventState3 = Max(e\EventState3-0.005*FPSfactor,0)
			EntityAlpha e\room\Objects[6],e\EventState3
			If e\EventState2 < 70*6
				e\EventState2 = e\EventState2 + FPSfactor
			ElseIf e\EventState2 >= 70*6 And e\EventState2 < 70*10
				...
				e\EventState2 = 70*10
			ElseIf e\EventState2 >= 70*10 And e\EventState2 <= 70*15
				e\EventState2 = e\EventState2 + FPSfactor
			ElseIf e\EventState2 >= 70*15 And e\EventState2 < 70*20
				If e\Sound2<>0 Then FreeSound_Strict(e\Sound2)
				e\Sound2 = LoadSound_Strict("SFX\Room\Intro\Line2.ogg")
				e\SoundCHN2 = PlaySound_Strict(e\Sound2)
				e\EventState2 = 70*20
			ElseIf e\EventState2 >= 70*20 And e\EventState2 < 70*25
				e\EventState2 = e\EventState2 + FPSfactor
			EndIf
		...
		ElseIf e\EventState = 3
			...
			If EntityDistanceSquared(e\room\Objects[0],e\room\Objects[3])>PowTwo(0.05)
				e\EventState3 = Min(e\EventState3+0.01*FPSfactor,1)
				EntityAlpha e\room\Objects[6],e\EventState3
				oldpitch# = EntityPitch(e\room\Objects[0])
				PointEntity e\room\Objects[0],e\room\Objects[3]
				e\EventState2 = CurveValue(0.25,e\EventState2,25.0)
				MoveEntity e\room\Objects[0],0,0,e\EventState2*FPSfactor
				RotateEntity e\room\Objects[0],oldpitch#,EntityYaw(e\room\Objects[0]),EntityRoll(e\room\Objects[0])
		...
		ElseIf e\EventState = 6
			...
			If EntityDistanceSquared(e\room\NPC[0]\Collider,e\room\Objects[7]) < PowTwo(2.5) And EntityDistanceSquared(e\room\NPC[1]\Collider,e\room\Objects[7]) < PowTwo(2.5) Then 
				...
				e\EventState2 = UpdateElevators(e\EventState2,e\room\RoomDoors[0],e\room\RoomDoors[1],e\room\Objects[7],e\room\Objects[8],e)
			Else
