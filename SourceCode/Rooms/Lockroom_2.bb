...
Function FillRoom_Lockroom_2(r.Rooms)
	...
	For i = 0 To 5
		...
		de.Decals = CreateDecal(GetRandomDecalID(DECAL_TYPE_BLOODDROP), r\x+Rnd(-392,520)*RoomScale, 3.0*RoomScale+Rnd(0,0.001), r\z+Rnd(-392,520)*RoomScale,90,Rnd(360),0)
		de\Size = Rnd(0.1,0.6)
		ScaleSprite(de\obj, de\Size,de\Size)
		EntityParent(de\obj, r\obj)
		de.Decals = CreateDecal(GetRandomDecalID(DECAL_TYPE_BLOODDROP), r\x+Rnd(-0.5,0.5), 3.0*RoomScale+Rnd(0,0.001), r\z+Rnd(-0.5,0.5),90,Rnd(360),0)
		de\Size = Rnd(0.1,0.6)
		ScaleSprite(de\obj, de\Size,de\Size)
		EntityParent(de\obj, r\obj)
	Next
