...
Function UpdateEvent_Room2_Maintenance(e.Events)
	...
	If PlayerRoom = e\room
		If EntityY(Collider)<-3500.0*RoomScale ;Level 1
			...
			RotateEntity(e\room\Objects[6], Sin(Float(e\EventState2)*1.4), EntityYaw(e\room\Objects[6],True), EntityRoll(e\room\Objects[6],True), True)
			...
			Select e\EventState
				...
				Case 3
					PositionTexture e\room\Objects[3],0,e\EventState2*0.005
