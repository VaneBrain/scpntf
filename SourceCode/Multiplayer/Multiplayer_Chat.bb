...
Function UpdateChat()
	...
	If MenuOpen Lor ConsoleOpen Lor IsPlayerListOpen() Lor IsModerationOpen() Lor (Not HUDenabled) Then
		Return
	EndIf
...
Function RenderChat()
	...
	If InLobby() Lor MenuOpen Lor ConsoleOpen Lor IsPlayerListOpen() Lor IsModerationOpen() Lor (Not HUDenabled) Then
		Return
	EndIf
