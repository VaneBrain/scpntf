	...
	If PlayerRoom = e\room
		...
		If dist < PowTwo(2.0) Then
			...
			If dist<0.5 Then
				...
				e\EventState=Min(e\EventState+FPSfactor/200.0,2.0)
				
				LightBlink = Min(e\EventState*5,10.0)
				BlurTimer = e\EventState*500
				
				If e\EventState = 2.0 Then MoveToPocketDimension()
			EndIf
		EndIf
	Else 
		e\EventState=0
