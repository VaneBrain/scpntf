...
Function UpdateNPCtype049(n.NPCs)
	...
	;state2 = attacks the player when the value is above 0.0
	...
	Else
		...
		Select n\State
			Case SCP049_NULL ;nothing (used for events)
								...
								If (Not GodMode) Then
									If PlayerRoom\RoomTemplate\Name$ = "cont_049"
										...
										For e.Events = Each Events
											If e\EventName = "cont_049" Then e\EventState=-1 : Exit
										Next
									Else
			...
			Case SCP049_ROOM2SL ;used for "room2sl"
				...
				If PlayerRoom\RoomTemplate\Name = "surveil_room" Then
					ShouldPlay = 20
				EndIf
